 ...
 * @property {string} createdAt.required - The date when the company entry was created. - json:{"format":"date-time"}
 * @property {string | null} deletedAt - The date when the company entry was deleted, or null if not deleted. - json:{"format":"date-time"}
 */
